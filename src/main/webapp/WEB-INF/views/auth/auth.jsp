                ...
                <form class="layui-form" action="" onsubmit="javascript:;" name="form" method="post">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="authName" lay-verify="required" autocomplete="off" placeholder="请输入权限名称" class="layui-input">
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="authUrl" lay-verify="required" autocomplete="off" placeholder="/home" class="layui-input" value="/">
                        </div>
                        <div class="layui-form-mid layui-word-aux"></div>
                    </div>
    ...
    <script>
        ...
        layui.config({
            ...
            form.on("submit",function(data) {
                ...
                $.post('/auth/saveNode', data.field, function (out) {
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            function editOnClick(e, treeId, treeNode) {
                ...
                $("#id").val(nodes[0].id);
                $("#pname").val(pname);
                $("form[name=form]").find("input[name=authName]").val(nodes[0].name);
            ...
            $('#del').on('click',function(){
                ...
                layer.confirm('确认要删除吗？', {icon: 3, title:'提示'}, function(index){
                    $.post('/auth/deleteNode', {id:id}, function (out) {
                        if (out.status == 200) {
                            layer.alert(out.message, {icon: 1},function(index){
                                window.location.reload();
                            });
