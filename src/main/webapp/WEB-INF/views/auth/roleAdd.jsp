                ...
                <form class="layui-form" action="" onsubmit="javascript:;" name="form" method="post">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="roleName" id="roleName" lay-verify="required" autocomplete="off" placeholder="请输入角色名称" class="layui-input">
                        </div>
...
<script>
    ...
    layui.config({
        ...
        $("form").submit(function () {
            ...
            var data = {'roleName':role_name,'detail':detail,'authNodes':nodes_data}
            console.log(data)
